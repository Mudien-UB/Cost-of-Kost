                    ...
                    >
                        <div className="grid grid-cols-2">
                            <div className="flex p-0 items-center gap-10">
                                <h1 className="text-lg font-bold text-blue-900/60">{item.date}</h1>
                                <div>
                                    <h3 className="text-lg font-bold text-blue-900/60">{item.title}</h3>
                                    <p className="text-sm font-bold text-blue-900/50">{item.category}</p>
                                </div>
                            </div>
